...
class BackupAgent:
    ...
    def backup(self):
        ...
        if full_backup_was_already_running or not is_full_backup:
            logging.info("Try to run transaction backup full_backup_was_already_running={already} is_full_backup={full}".format(
